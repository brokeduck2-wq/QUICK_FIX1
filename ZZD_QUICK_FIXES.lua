...
local onTickZZD = function(numTicksInZZD) 
    if numTicksInZZD % 2 == 0 or numTicksInZZD % 2 ~= 0 then
        ...
        -- creating wrappers/intercepts for several BWO global functions for certain events that are being triggered far more than they should with the following fixerFunc:
